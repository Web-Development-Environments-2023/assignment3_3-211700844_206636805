     ...
     <b-card 
       ...
       <b-card-text class="recipePreviewDetailsText">
         <b-list-group >
           ...
           <dt v-if="!is_family && recipe.favorite"><img src="../assets/love.png" style="width: 30px"/>  Favorite Recipe</dt>
           <button v-if="$root.store.username &&!is_family && !recipe.favorite"  v-on:click="AddToFavorites" style="color: white; background: transparent; border: none; width: 250px; margin-left: 30px;"><img src="../assets/no_love.png" style="width: 30px" />No in Favorite</button>
           <dt v-if="!is_family && recipe.seen"><img src="../assets/check.png" style="width: 25px"/>   Viewed Recipe</dt>
         </b-list-group>
       </b-card-text>
     </b-card>
     <br>
